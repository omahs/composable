...
fn veto_external_works() {
	new_test_ext().execute_with(|| {
		...
		assert_ok!(Democracy::external_propose(
			Origin::signed(2),
			set_balance_proposal_hash_and_note(BTC, 3),
		));
	});
}
...
fn external_and_public_interleaving_works() {
	new_test_ext().execute_with(|| {
		...
		assert_ok!(Democracy::external_propose(
			Origin::signed(2),
			set_balance_proposal_hash_and_note(BTC, 1),
		));
		...
		assert_eq!(
			...
			Ok(ReferendumStatus {
				...
				proposal_hash: set_balance_proposal_hash_and_note(BTC, 1),
				threshold: VoteThreshold::SuperMajorityApprove,
				delay: 2,
				tally: Tally { ayes: 0, nays: 0, turnout: 0 },
			})
		...
		assert_eq!(
			...
			Ok(ReferendumStatus {
				...
				proposal_hash: set_balance_proposal_hash_and_note(BTC, 3),
				threshold: VoteThreshold::SuperMajorityApprove,
				delay: 2,
				tally: Tally { ayes: 0, nays: 0, turnout: 0 },
			})
		...
		assert_ok!(Democracy::external_propose(
			Origin::signed(2),
			set_balance_proposal_hash_and_note(BTC, 5),
		));
		...
		assert_eq!(
			...
			Ok(ReferendumStatus {
				...
				proposal_hash: set_balance_proposal_hash_and_note(BTC, 5),
				threshold: VoteThreshold::SuperMajorityApprove,
				delay: 2,
				tally: Tally { ayes: 0, nays: 0, turnout: 0 },
			})
		...
		assert_ok!(Democracy::external_propose(
			Origin::signed(2),
			set_balance_proposal_hash_and_note(BTC, 7),
		));
		...
		assert_eq!(
			...
			Ok(ReferendumStatus {
				...
				proposal_hash: set_balance_proposal_hash_and_note(BTC, 4),
				threshold: VoteThreshold::SuperMajorityApprove,
				delay: 2,
				tally: Tally { ayes: 0, nays: 0, turnout: 0 },
			})
		...
		// cancel external
		let h = set_balance_proposal_hash_and_note(BTC, 7);
		...
		assert_eq!(
			...
			Ok(ReferendumStatus {
				...
				proposal_hash: set_balance_proposal_hash_and_note(BTC, 6),
				threshold: VoteThreshold::SuperMajorityApprove,
				delay: 2,
				tally: Tally { ayes: 0, nays: 0, turnout: 0 },
			})
