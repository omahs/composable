...
pub trait OrderIdLike: FullCodec + Copy + Eq + PartialEq + sp_std::fmt::Debug + TypeInfo + sp_std::hash::Hash {}
impl<T: FullCodec + Copy + Eq + PartialEq + sp_std::fmt::Debug + TypeInfo + sp_std::hash::Hash> OrderIdLike for T {}


pub trait SellTrait<Configuration> : DeFiTrait {
