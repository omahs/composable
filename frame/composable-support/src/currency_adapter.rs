...
use frame_support::{
	...
	traits::{
		tokens::AssetId as TAssetId, Currency, ExistenceRequirement, Get, SignedImbalance,
		WithdrawReasons,
	},
};
	...
	> Currency<AccountId> for CurrencyAdapter<MultiCurrencyImpl, ThisAssetId>
{
	...
	fn total_issuance() -> Self::Balance {
		MultiCurrencyImpl::total_issuance(ThisAssetId::get())
	}

	fn minimum_balance() -> Self::Balance {
		MultiCurrencyImpl::minimum_balance(ThisAssetId::get())
	}

	fn burn(amount: Self::Balance) -> Self::PositiveImbalance {
		MultiCurrencyImpl::burn(ThisAssetId::get(), amount)
	}
	...
	fn free_balance(who: &AccountId) -> Self::Balance {
		MultiCurrencyImpl::free_balance(ThisAssetId::get(), who)
	}
