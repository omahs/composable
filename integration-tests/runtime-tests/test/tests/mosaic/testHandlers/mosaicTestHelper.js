...
class TxMosaicTests {
    ...
    static async testTransferTo(api, relayerWallet, networkId, assetId, ethAddress, transferAmount) {
        ...
        return await (0, polkadotjs_1.sendAndWaitForSuccess)(api, relayerWallet, api.events.mosaic.TransferOut.is, api.tx.mosaic.transferTo(networkId, pAssetId, contractAddress, pAmount, pKeepAlive));
    }
    /**
