...
describe("HAL01 [Oracle] Tests", function () {
    ...
    describe("HAL01: Adding stakes", function () {
        it("HAL01: Adding stake 1", async function () {
            ...
            const { data: [result] } = await (0, addStakeTests_1.txOracleAddStakeSuccessTest)(api, walletHAL01_1, stake);
        ...
        it("HAL01: Adding stake 2", async function () {
            this.timeout(2 * 60 * 1000);
            const stake = api.createType("u128", 2500000000000);
            const { data: [result] } = await (0, addStakeTests_1.txOracleAddStakeSuccessTest)(api, walletHAL01_2, stake);
            (0, chai_1.expect)(result).to.not.be.an("Error");
            (0, chai_1.expect)(result.toString()).to.be.equal(api.createType("AccountId32", walletHAL01_3.publicKey).toString());
        });
        it("HAL01: Adding stake 3", async function () {
            this.timeout(2 * 60 * 1000);
            const stake = api.createType("u128", 2500000000000);
            const { data: [result] } = await (0, addStakeTests_1.txOracleAddStakeSuccessTest)(api, walletHAL01_3, stake);
            (0, chai_1.expect)(result).to.not.be.an("Error");
            (0, chai_1.expect)(result.toString()).to.be.equal(api.createType("AccountId32", walletHAL01_4.publicKey).toString());
        });
        it("HAL01: Adding stake 4", async function () {
            this.timeout(2 * 60 * 1000);
            const stake = api.createType("u128", 2500000000000);
            const { data: [result] } = await (0, addStakeTests_1.txOracleAddStakeSuccessTest)(api, walletHAL01_4, stake);
            (0, chai_1.expect)(result).to.not.be.an("Error");
