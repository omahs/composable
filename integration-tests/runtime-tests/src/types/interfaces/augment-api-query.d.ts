...
declare module "@polkadot/api-base/types/storage" {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        ibc: {
             ...
             **/
            acknowledgements: AugmentedQuery<ApiType, (arg: ITuple<[Bytes, Bytes, u64]> | [Bytes | string | Uint8Array, Bytes | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Bytes>, [
             ...
             **/
            channels: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<Bytes>, [
                Bytes,
                Bytes
             ...
             **/
            channelsConnection: AugmentedQuery<ApiType, (arg: Bytes | string | Uint8Array) => Observable<Vec<ITuple<[Bytes, Bytes]>>>, [
                Bytes
             ...
             **/
            clientUpdateHeight: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<Bytes>, [
                Bytes,
                Bytes
            ]> & QueryableStorageEntry<ApiType, [Bytes, Bytes]>;
            /**
             ...
             **/
            clientUpdateTime: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<u64>, [
                Bytes,
                Bytes
            ]> & QueryableStorageEntry<ApiType, [Bytes, Bytes]>;
            /**
             ...
             **/
            consensusStates: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<Bytes>, [
                Bytes,
                Bytes
            ]> & QueryableStorageEntry<ApiType, [Bytes, Bytes]>;
            /**
             ...
             **/
            nextSequenceAck: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<u64>, [
                Bytes,
                Bytes
            ]> & QueryableStorageEntry<ApiType, [Bytes, Bytes]>;
            /**
             * (port_identifier, channel_identifier) => Sequence
             **/
            nextSequenceRecv: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<u64>, [
                Bytes,
                Bytes
            ]> & QueryableStorageEntry<ApiType, [Bytes, Bytes]>;
            /**
             * (port_identifier, channel_identifier) => Sequence
             **/
            nextSequenceSend: AugmentedQuery<ApiType, (arg1: Bytes | string | Uint8Array, arg2: Bytes | string | Uint8Array) => Observable<u64>, [
                Bytes,
                Bytes
            ]> & QueryableStorageEntry<ApiType, [Bytes, Bytes]>;
            /**
             ...
             **/
            packetCommitment: AugmentedQuery<ApiType, (arg: ITuple<[Bytes, Bytes, u64]> | [Bytes | string | Uint8Array, Bytes | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Bytes>, [
                ITuple<[Bytes, Bytes, u64]>
            ]> & QueryableStorageEntry<ApiType, [ITuple<[Bytes, Bytes, u64]>]>;
            /**
             * (port_id, channel_id, sequence) => receipt
             **/
            packetReceipt: AugmentedQuery<ApiType, (arg: ITuple<[Bytes, Bytes, u64]> | [Bytes | string | Uint8Array, Bytes | string | Uint8Array, u64 | AnyNumber | Uint8Array]) => Observable<Bytes>, [
                ITuple<[Bytes, Bytes, u64]>
            ]> & QueryableStorageEntry<ApiType, [ITuple<[Bytes, Bytes, u64]>]>;
            /**
             * Generic query
