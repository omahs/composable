module.exports = class Init1662632334932 {
  name = 'Init1662632334932'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "activity" ("id" character varying NOT NULL, "account_id" text NOT NULL, "timestamp" numeric NOT NULL, "event_id" character varying NOT NULL, CONSTRAINT "PK_24625a1d6b1b089c8ae206fe467" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "pablo_transaction" ("id" character varying NOT NULL, "base_asset_id" text NOT NULL, "base_asset_amount" numeric NOT NULL, "quote_asset_id" text NOT NULL, "quote_asset_amount" numeric NOT NULL, "spot_price" text NOT NULL, "fee" text NOT NULL, "event_id" character varying NOT NULL, "pool_id" character varying NOT NULL, CONSTRAINT "REL_0118a010cf1571fc5cb70b90a7" UNIQUE ("event_id"), CONSTRAINT "PK_8b040ecc6da14a71ef547ae2ae6" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "staking_position" ("id" character varying NOT NULL, "position_id" text NOT NULL, "owner" text NOT NULL, "asset_id" text NOT NULL, "amount" numeric NOT NULL, "start_timestamp" numeric NOT NULL, "end_timestamp" numeric, "source" character varying(14) NOT NULL, "event_id" character varying NOT NULL, CONSTRAINT "REL_3e2e1b465d89dbb2736e70fe5f" UNIQUE ("event_id"), CONSTRAINT "PK_899113a8f0b5ec707171ff4db6b" PRIMARY KEY ("id"))`)
