...
declare module '@polkadot/types/lookup' {
  ...
  /** @name ComposableTraitsDexFee (163) */
  ...
  /** @name PalletStakingRewardsEvent (169) */
  ...
  /** @name PalletStakingRewardsRewardAccumulationHookError (173) */
  ...
  /** @name PalletCallFilterEvent (174) */
  ...
  interface PalletCosmwasmEvent extends Enum {
    ...
    readonly type: 'Uploaded' | 'Instantiated' | 'Executed' | 'ExecutionFailed' | 'Emitted' | 'Migrated' | 'AdminUpdated' | 'AdminCleared';
  }
  ...
  /** @name PalletAssetTxPaymentCall (208) */
  ...
  /** @name ComposableTraitsCurrencyRational64 (346) */
  ...
  /** @name ComposableTraitsAccountProxyProxyDefinition (528) */
  ...
  /** @name PalletAccountProxyAnnouncement (532) */
  ...
  /** @name PalletAccountProxyError (534) */
