...
export class StakingRewardsRewardPoolCreatedEvent {
   ...
   */
  get isV2401(): boolean {
    return this._chain.getEventHash('StakingRewards.RewardPoolCreated') === 'c1a7d8c28ed34c95044288fd755b6243bfb8451b8f7bb43754a90d57fedb3529'
  }

  /**
   * Pool with specified id `T::AssetId` was created successfully by `T::AccountId`.
   */
  get asV2401(): {poolId: bigint, owner: Uint8Array, endBlock: number, assetId: bigint} {
    assert(this.isV2401)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class StakingRewardsSplitPositionEvent {
   ...
   */
  get isV2401(): boolean {
    return this._chain.getEventHash('StakingRewards.SplitPosition') === '5d9eb209c412b137d1ef45620c5151241d00f670ec3e855e9e2d7fec32b88ccc'
  }
...
export class StakingRewardsStakeAmountExtendedEvent {
  ...
  get isV2401(): boolean {
    return this._chain.getEventHash('StakingRewards.StakeAmountExtended') === '9b62bc61f3b135250dbe07edc824ed6e892ce57d5e350302f3f80b5a1d202768'
  }
...
export class StakingRewardsStakedEvent {
  ...
  get isV2401(): boolean {
    return this._chain.getEventHash('StakingRewards.Staked') === '9bd2bf805153832d25298c66acf49d2bcbbce04060a4d9b68d5e3221557e2c3e'
  }

  get asV2401(): {poolId: bigint, owner: Uint8Array, amount: bigint, durationPreset: bigint, positionId: bigint, keepAlive: boolean} {
    assert(this.isV2401)
    return this._chain.decodeEvent(this.event)
  }
}
...
export class StakingRewardsUnstakedEvent {
  ...
  get isV2401(): boolean {
    return this._chain.getEventHash('StakingRewards.Unstaked') === 'a77303deb074b7208720e047715198fb967f6c69ff250d6b1a1a5a58a1a0e665'
  }

  get asV2401(): {owner: Uint8Array, positionId: bigint} {
    assert(this.isV2401)
    return this._chain.decodeEvent(this.event)
  }
}
